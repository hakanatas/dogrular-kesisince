...
//   npm run bundle   → dist/dogrular-kesisince.html  (easy to email, put on a USB stick, or host)
...
fs.writeFileSync(path.join(root, 'dist', 'dogrular-kesisince.html'), html);
console.log('✓ dist/dogrular-kesisince.html', (html.length / 1024).toFixed(0) + ' KB');
...
fs.writeFileSync(path.join(root, 'dist', 'dogrular-kesisince.artifact.html'), art);
console.log('✓ dist/dogrular-kesisince.artifact.html');
